---
title: "Dockerize Services in Personal Linux Server"
layout: post
tags: basic
comments: true
---
...
The verb `Dockerize` means to put/wrap something, such as service or application, into a docker container. I will go through the setups for dockerize **four services** from scratch in following threads.
